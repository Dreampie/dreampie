...
}}(this,function(){var c="2.2.1-javascript",a={},d,g=[],f=[],e=0,b=Object.prototype.hasOwnProperty;
...
aC.stime=a.util.trim(aD[aH+1]);
if(aD.length<=aH+3){a.util.log("error",["Protocol data not sent by the server. If you enable protocol on client side, be sure to install JavascriptProtocol interceptor on server side.Also note that atmosphere-runtime 2.2+ should be used."])
}var aB=parseInt(a.util.trim(aD[aH+2]),10);
var aG=aD[aH+3];
