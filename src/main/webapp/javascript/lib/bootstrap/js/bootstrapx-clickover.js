...
!function($) {
    ...
    Clickover.prototype = $.extend({}, $.fn.popover.Constructor.prototype, {
        ...
        , clickery: function(e) {
            ...
            // add a custom class
            this.options.class_pop && this.tip().addClass(this.options.class_pop);
            ...
            if ( this.isShown() ) {
                ...
                this.options.class_btn && this.$element.addClass(this.options.class_btn);
                ...
                this.options.class_btn && this.$element.removeClass(this.options.class_btn);
...
// provide some callback hooks
    ...
    $.fn.clickover.defaults = $.extend({}, $.fn.popover.defaults, {
        ...
        class_btn:'btnhover',/*trigger button*/
        class_pop: 'clickover', /* default class name in addition to other classes */
