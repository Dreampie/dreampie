...
(function ($, undefined) {
  ...
  $.extend(Valid.prototype, {
    ...
    showError: function (errors) {
      ...
      $.each(errors, function (k, v) {
        ...
        if (self.options.wrapper !== null) {
          $input.closest(self.options.wrapper).addClass('error-box');
        } else {
        ...
        if (!self.options.boxer.exist) {
          ...
          var $boxer = self.$form.find('.error-box');
          if ($boxer.html() === '') {
            $boxer.append(v);
          } else
  ...
  $.fn[pluginName].defaults = {
    ...
    , boxer: {box: 'span', exist: false, separator: '<br/>'} //messages box
