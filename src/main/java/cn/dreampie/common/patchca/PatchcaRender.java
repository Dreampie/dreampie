...
import cn.dreampie.common.patchca.font.RandomFontFactory;
import cn.dreampie.common.patchca.service.Captcha;
import cn.dreampie.common.patchca.service.ConfigurableCaptchaService;
import cn.dreampie.common.patchca.text.renderer.BestFitTextRenderer;
import cn.dreampie.common.patchca.text.renderer.TextRenderer;
...
public class PatchcaRender extends Render {
    ...
    public void render() {
        ...
        session.setAttribute(CommonAttrs.CAPTCHA_NAME, EncriptionUtils.encrypt(captchaCode));
    ...
    public static boolean validate(Controller controller, String inputCode) {
        ...
        try {
            if (use_code) {
                ...
                return inputCode.equals(controller.getCookie(CommonAttrs.CAPTCHA_NAME));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
