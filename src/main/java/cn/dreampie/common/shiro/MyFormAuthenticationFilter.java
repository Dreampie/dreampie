 ...
 * <p/>
 * <p>This filter constructs a {@link org.apache.shiro.authc.UsernamePasswordToken UsernamePasswordToken} with the values found in
...
public class MyFormAuthenticationFilter extends MyAuthenticatingFilter {
  ...
  protected void setFailureAttribute(ServletRequest request, ServletResponse response, AuthenticationException ae) {
    ...
    getSubject(request, response).getSession().setAttribute(getFailureKeyAttribute(), className);
  }
