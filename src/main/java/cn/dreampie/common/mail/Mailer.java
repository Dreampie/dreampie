    ...
    Akka.system().scheduler().scheduleOnce(Duration.create(1000, TimeUnit.MILLISECONDS),
        new Runnable() {
          ...
          public void run() {
            ...
            htmlEmail.setSmtpPort(mailerConf.getPort());
            ...
            htmlEmail.setAuthentication(mailerConf.getUser(), mailerConf.getPassword());
            try {
    ...
    Akka.system().scheduler().scheduleOnce(Duration.create(1000, TimeUnit.MILLISECONDS),
        new Runnable() {
          ...
          public void run() {
            ...
            simpleEmail.setSmtpPort(mailerConf.getPort());
    ...
    Akka.system().scheduler().scheduleOnce(Duration.create(1000, TimeUnit.MILLISECONDS),
        new Runnable() {
          ...
          public void run() {
            ...
            multiPartEmail.setSmtpPort(mailerConf.getPort());
